...
/*   Updated: 2020/07/16 02:14:46 by alopez-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char **argv)
{
    ...
    if (test == 'p' || test == 'a')
    {
        ...
        n1 =    printf(	  "BUENO: _HOLA_%0.p_HOLA\n", 0);
	    n0 =    ft_printf( "VERGA: _HOLA_%0.p_HOLA\n", 0);
    	printf(n0 == n1 ? "\033[0;32mOK\033[0m" : "\033[0;31mKO: V:%d B:%d\033[0m", n0, n1);
        error = n0 == n1 ? error : error + 1;
        printf("\n\n");

        n1 =    printf(	  "BUENO: _HOLA_%03.p_HOLA\n", 0);
	    n0 =    ft_printf( "VERGA: _HOLA_%03.p_HOLA\n", 0);
    	printf(n0 == n1 ? "\033[0;32mOK\033[0m" : "\033[0;31mKO: V:%d B:%d\033[0m", n0, n1);
        error = n0 == n1 ? error : error + 1;
        printf("\n\n");
    }
